...
<template>
  <div
    class="card card-border w-full border-base-300 bg-base-100 card-sm overflow-hidden"
  >
    <div class="card-body gap-4">
      <div
        class="grid grid-cols-7 border-b border-dashed border-b-base-300 pb-3"
      >
      ...
      <div>
        <label
          class="input input-sm input-border w-auto flex gap-2 items-center"
        >
          <svg
