...
<template>
  <div
    class="card card-border border-base-300 bg-base-100 card-sm w-full max-w-80 overflow-hidden"
  >
    ...
    <div class="card-body gap-4">
      ...
      <div class="flex flex-col gap-1">
        ...
        <span
          class="text-[0.6875rem] px-1 flex gap-2 items-center text-base-content/60"
        >
          <span class="status inline-block status-error" />
