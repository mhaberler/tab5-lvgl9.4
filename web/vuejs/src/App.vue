  ...
  <div class="container mx-auto p-4 max-w-4xl">
    ...
    <FwbCard class="mb-6 p-4">
      ...
      <div class="flex items-center gap-4 mb-4">
        ...
        <FwbBadge type="indigo">
          {{ uptime }}s
        </FwbBadge>
        <span class="text-gray-700 dark:text-gray-300">LED:</span>
        <FwbBadge :type="ledState ? 'green' : 'dark'">
          {{ ledState ? "ON" : "OFF" }}
        </FwbBadge>
      </div>
              ...
              <td class="px-3 py-2">
                ...
                >
                  ...
                  <button
                    ...
                    @click="saveCred(net.ssid, editingPw)"
                  >
                    OK
                  </button>
                  <button
                ...
                <button
                  v-else-if="!net.connected"
                  class="text-xs text-red-600 hover:underline dark:text-red-400"
                  @click="forgetCred(net.ssid)"
                >
                  Forget
                </button>
              </td>
